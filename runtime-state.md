...
Claude Code skills store reflections, handoffs, and generated plans in repo-scoped runtime paths so unrelated repos, branches, worktrees, and runs do not collide.
...
- Reflection: `~/.claude/skills/<skill>/reflections/<repo_hash>/<branch_slug>/<run_id>.md`
- Handoff: `~/.claude/skills/<skill>/handoffs/<repo_hash>/<branch_slug>/<run_id>.md`
- Latest handoff pointer: `~/.claude/skills/<skill>/handoffs/<repo_hash>/<branch_slug>/latest.md`
- Plan output, when runtime-local: `~/.claude/skills/<skill>/plans/<repo_hash>/<branch_slug>/<run_id>.md`
...
5. Do not write Claude runtime paths from Claude Code skills.
...
2. Read `~/.claude/skills/<predecessor>/handoffs/<repo_hash>/<branch_slug>/latest.md`.
...
- `~/.claude/skills/<skill>/reflections/**`
- `claude-config/claude-skills/<skill>/reflections/**`
